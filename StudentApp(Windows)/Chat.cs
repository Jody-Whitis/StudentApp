...
namespace StudentApp_Windows_
{
    public partial class Chat : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'studentAppDataSet3.StudentTable' table. You can move, or remove it, as needed.
            this.studentTableTableAdapter1.Fill(this.studentAppDataSet3.StudentTable);
...
=C:\Users\Jcomp\Documents\College\Senior Project\StudentApp(Windows)\StudentApp(Windows)\StudentApp.mdf;Integrated Security=True"))
        ...
        private void fillByNamesToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                this.studentTableTableAdapter.FillByNames(this.studentAppDataSet.StudentTable);
            }
